...
+function (t) {
  ...
  var hoverHandled = false; // Flag to check if hover event is already handled

  t(document).on("mouseenter.bs.collapse.data-api", '[data-toggle="collapse"]', function () {
    var target = e(t(this));
  ...
  t(document).on("mouseleave.bs.collapse.data-api", '[data-toggle="collapse"]', function () {
    hoverHandled = false;
  });
