        ...
        t.isotope({
          ...
          t
            ...
            .on("click", function () {
              ...
              return void 0 !== n ? (t.isotope({ filter: n }), !1) : void 0;
            });
      });
    }),
            ...
            function () {
              ...
              t
                .circleProgress({
                  ...
                  lineCap: "round",
                  fill: { gradient: [n, i], gradientAngle: Math.PI / 4 },
                })
      ...
      (CRUMINA.elementChart = function () {
        ...
        e.each(i, function (a, o) {
          e.getJSON("json/" + o.name.toLowerCase() + "-c.json", function (e) {
            (t[a] = { name: o.name, data: e, color: o.color }),
